...
Sounds = имя wav-файла без расширения, требуется 22050 Hz, или несколько файлов разделенных пробелами (знак $ перед именем предназначается для использования в локализации, но, скорее всего, не служит никакой полезной цели, но и не является проблемой)  
